...
final public class Harvesting extends EnchantmentWrapper {
    // 收穫

    final static public Enchantment HARVESTING = new Harvesting("harvesting");

    public Harvesting(String name) {
        super(name);
    }
